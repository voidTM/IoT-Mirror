...
class SpellingDictionaryFromSet {
    ...
    get trie() {
        this._trie = this._trie || cspell_trie_lib_1.Trie.create(this.words);
        return this._trie;
    }
    ...
    suggest(word, numSuggestions, compoundMethod = cspell_trie_lib_1.CompoundWordsMethod.SEPARATE_WORDS, numChanges) {
    ...
    genSuggestions(collector, compoundMethod = cspell_trie_lib_1.CompoundWordsMethod.SEPARATE_WORDS) {
...
class SpellingDictionaryFromTrie {
    ...
    suggest(word, numSuggestions, compoundMethod = cspell_trie_lib_1.CompoundWordsMethod.SEPARATE_WORDS, numChanges) {
        word = this.mapWord(word).toLowerCase();
        compoundMethod = this.options.useCompounds ? cspell_trie_lib_1.CompoundWordsMethod.JOIN_WORDS : compoundMethod;
        return this.trie.suggestWithCost(word, numSuggestions || defaultSuggestions, compoundMethod, numChanges);
    }
    genSuggestions(collector, compoundMethod = cspell_trie_lib_1.CompoundWordsMethod.SEPARATE_WORDS) {
        compoundMethod = this.options.useCompounds ? cspell_trie_lib_1.CompoundWordsMethod.JOIN_WORDS : compoundMethod;
